<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<link href="static/register/css/register.css" rel="stylesheet" type="text/css" media="all" />
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="home">
						<form>
							...
							<div class="form-group">
								<label for="developer">피젯 배경</label> 
								<input type="text" class="form-control" id="feedgetBg" name="feedgetBg" placeholder="레이아웃 배경의 이미지(url)나 색상값(16진수)을 입력하세요.">
							</div>
							<div class="form-group">
